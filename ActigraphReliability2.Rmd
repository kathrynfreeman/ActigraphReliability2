...
etime_ga2_md_d <-  (pivot_wider(adjtime(df$etime) %>%
  filter(test == "same") %>%                                
  filter(analysis == "markdown" | analysis == "diary") %>% 
  filter(actigraph == "g1" | actigraph == "g2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = (adjtime)))

diary(etime_ga2_md_d)
```
### Sleep Time (stime)
#### Sleep Time (stime)
##### stime = time fell asleep at night
...
stime_ga2_md_d <- (pivot_wider(adjtime(df$stime) %>%
  filter(wearer == "Kate") %>%                               
  filter(test == "same") %>%                               
  filter(analysis == "markdown" | analysis == "diary") %>% 
  filter(actigraph == "g1" | actigraph == "g2" | actigraph == "d"), night, 
...
dur_ga2_md_d <- (pivot_wider(sleepduration(1) %>%
  filter(test == "same") %>%                             
  filter(analysis == "markdown" | analysis == "diary") %>% 
  filter(actigraph == "g1" | actigraph == "g2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = dur))
...
mid_ga2_md_d <- (pivot_wider(sleepmid(1) %>%
  filter(test == "same") %>%                             
  filter(analysis == "markdown" | analysis == "diary") %>% 
  filter(actigraph == "g1" | actigraph == "g2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = mid))
...
tinb_mod <- (pivot_wider(df %>% filter(test == "same") %>%  
...
mo2(pslp_mo2, "Percent Sleep", "Motionlogger 1 (mins)", 
       "Motionlogger 2 (mins)", "Two Motionloggers")

pslp_mod <- (pivot_wider(df %>% filter(test == "same") %>%
  filter(actigraph == "m1" | actigraph == "m2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = (pslp)))
...
smin_mod <- (pivot_wider(df  %>% filter(test == "same") %>%
  filter(actigraph == "m1" | actigraph == "m2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = (smin)))
...
wmin_mod <- (pivot_wider(df %>% filter(test == "same") %>%
  filter(actigraph == "m1" | actigraph == "m2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = (wmin)))
...
etime_mod <-  (pivot_wider(adjtime(df$etime) %>% filter(test == "same") %>%
  filter(actigraph == "m1" | actigraph == "m2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = (adjtime)))
...
stime_mod <- (pivot_wider(adjtime(df$stime) %>%  filter(test == "same") %>%
  filter(actigraph == "m1" | actigraph == "m2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = (adjtime)))
...
dur_mod<- (pivot_wider(sleepduration(1) %>%  filter(test == "same") %>%
  filter(actigraph == "m1" | actigraph == "m2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = dur))
...
mid_mod <- (pivot_wider(sleepmid(1) %>% filter(test == "same") %>%
  filter(actigraph == "m1" | actigraph == "m2" | actigraph == "d"), night, 
  names_from = actigraph, values_from = mid))
